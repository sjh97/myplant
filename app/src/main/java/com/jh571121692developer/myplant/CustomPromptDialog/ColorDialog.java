...
public class ColorDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = View.inflate(getContext(), cn.refactor.lib.colordialog.R.layout.layout_colordialog, null);
        setContentView(contentView);

        mDialogView = getWindow().getDecorView().findViewById(android.R.id.content);
        mBkgView = contentView.findViewById(cn.refactor.lib.colordialog.R.id.llBkg);
        mTitleTv = (TextView) contentView.findViewById(cn.refactor.lib.colordialog.R.id.tvTitle);
        mContentTv = (TextView) contentView.findViewById(cn.refactor.lib.colordialog.R.id.tvContent);
        mContentIv = (ImageView) contentView.findViewById(cn.refactor.lib.colordialog.R.id.ivContent);

        mPositiveBtn = (TextView) contentView.findViewById(cn.refactor.lib.colordialog.R.id.btnPositive);
        mNegativeBtn = (TextView) contentView.findViewById(cn.refactor.lib.colordialog.R.id.btnNegative);

        mDividerView = contentView.findViewById(cn.refactor.lib.colordialog.R.id.divider);
        mBtnGroupView = contentView.findViewById(cn.refactor.lib.colordialog.R.id.llBtnGroup);
        ...
        if (null == mPositiveListener && null == mNegativeListener) {
            ...
            mNegativeBtn.setBackgroundDrawable(getContext().getResources().getDrawable(cn.refactor.lib.colordialog.R.drawable.sel_def_gray));
        } else if (null != mPositiveListener && null == mNegativeListener ) {
            mNegativeBtn.setVisibility(View.GONE);
            mDividerView.setVisibility(View.GONE);
            mPositiveBtn.setBackgroundDrawable(getContext().getResources().getDrawable(cn.refactor.lib.colordialog.R.drawable.sel_def_gray));
        }
    ...
    public void onClick(View v) {
        ...
        if (cn.refactor.lib.colordialog.R.id.btnPositive == id) {
            mPositiveListener.onClick(this);
        } else if (cn.refactor.lib.colordialog.R.id.btnNegative == id) {
