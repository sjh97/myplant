 ...
 * 描述 : 提示性的Dialog
 */
public class CustomDiaryPromptDialog extends Dialog{
    ...
    private ImageView addDatePickerView, addGalleryView;
    private TextView addDiaryDate;
    private TextInputEditText addDiaryDetail;
    private EditText addInterest1, addInterest2, addInterest3;

    private int mDialogType;
    private boolean mIsShowAnim;
    private CharSequence mTitle, mContent, mBtnText;

    public CustomDiaryPromptDialog(Context context) {
        this(context, 0);
    }

    public CustomDiaryPromptDialog(Context context, int theme) {
        super(context, cn.refactor.lib.colordialog.R.style.color_dialog);
        init();
    }

    public CustomDiaryPromptDialog(Context context, Drawable drawable) {
        this(context, 0);
    ...
    private void initView() {
        contentView = View.inflate(getContext(), R.layout.layout_custom_diary_promptdialog, null);
        ...
        addGalleryView = contentView.findViewById(R.id.add_diaryGallery);
        addDatePickerView = contentView.findViewById(R.id.add_diaryDatePicker);
        ...
        mPositiveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnPositiveListener != null) {
                    mOnPositiveListener.onClick(CustomDiaryPromptDialog.this);
                }
            }
        });
    ...
    public CustomDiaryPromptDialog setAnimationEnable(boolean enable) {
        mIsShowAnim = enable;
        return this;
    }

    public CustomDiaryPromptDialog setTitleText(CharSequence title) {
        mTitle = title;
        return this;
    }

    public CustomDiaryPromptDialog setTitleText(int resId) {
        return setTitleText(getContext().getString(resId));
    }

    public CustomDiaryPromptDialog setContentText(CharSequence content) {
        mContent = content;
        return this;
    }

    public CustomDiaryPromptDialog setContentText(int resId) {
    ...
    public CustomDiaryPromptDialog setDialogType(int type) {
        mDialogType = type;
        return this;
    }
    ...
    public CustomDiaryPromptDialog setPositiveListener(CharSequence btnText, OnPositiveListener l) {
        mBtnText = btnText;
        return setPositiveListener(l);
    }

    public CustomDiaryPromptDialog setPositiveListener(int stringResId, OnPositiveListener l) {
        return setPositiveListener(getContext().getString(stringResId), l);
    }

    public CustomDiaryPromptDialog setPositiveListener(OnPositiveListener l) {
        mOnPositiveListener = l;
        return this;
    }

    public CustomDiaryPromptDialog setAnimationIn(AnimationSet animIn) {
        mAnimIn = animIn;
        return this;
    }

    public CustomDiaryPromptDialog setAnimationOut(AnimationSet animOut) {
        mAnimOut = animOut;
        initAnimListener();
        return this;
    }
    ...
    public interface OnPositiveListener {
        void onClick(CustomDiaryPromptDialog dialog);
    }
